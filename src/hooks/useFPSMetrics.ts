/**
 * Thanks Danny
 * https://www.dannyhwilliams.co.uk/a-simple-fps-counter-for-react-native
 */
...
export const useFPSMetrics = () => {
  ...
  return useMemo(
    () => ({ average: Math.ceil(frameState.average), fps: frameState.fps }),
    [frameState.average, frameState.fps],
  );
};
