...
import io.evix.reactnativetvexample.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("io.evix.reactnativetvexample.ReactNativeFlipper");
        aClass
